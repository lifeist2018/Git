...
macro(MacroBuildModuleLibrary)
  ...
  CMAKE_PARSE_ARGUMENTS(MODULELIB
    "${options}"
    "${oneValueArgs}"
    "${multiValueArgs}"
    ${ARGN}
  ...
  # Sanity checks
  # --------------------------------------------------------------------------
  if(MODULELIB_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "Unknown keywords given to TIGSMacroBuildModuleLibrary(): \"${QTBASELIB_UNPARSED_ARGUMENTS}\"")
  endif()

  set(expected_defined_vars NAME EXPORT_DIRECTIVE)
  foreach(var ${expected_defined_vars})
    if(NOT DEFINED MODULELIB_${var})
